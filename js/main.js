...
;(function(window) {
	...
	function openContent(spacerefval) {
		...
		var activeSpaceArea1 = mallLevels[selectedLevel - 1].querySelector('svg > .map__space--selected');
		var activeSpaceArea2 = mallLevels[selectedLevel - 1].querySelector('svg > .map__seat--selected');
		if( activeSpaceArea1 ) {
			classie.remove(activeSpaceArea1, 'map__space--selected');
		}
		if(activeSpaceArea2){
			classie.remove(activeSpaceArea2, 'map__seat--selected');
		}
		...
		try{
			...
			classie.add(mallLevels[selectedLevel - 1].querySelector('svg > .map__seat[data-space="' + spaceref + '"]'), 'map__seat--selected');
		}
	}
